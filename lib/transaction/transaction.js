...
Transaction.MAX_MONEY = 50000000000 * 1e8;
...
Transaction.FEE_PER_KB = 100000; // Mangacoin default fees is 0.001 LTC
...
Transaction.prototype.checkedSerialize = function(opts) {
  ...
  if (serializationError) {
    serializationError.message += ' - For more information please see: ' +
      'http://mangacore.io/guide/transaction.html#serialization-checks';
 ...
 * and a slightly fancier format recognized by mangacore:
 *
 * ```
 * {
 ...
 * }
 * ```
 * Where `address` can be either a string or a mangacore Address object. The
 * same is true for `script`, which can be a string or a mangacore Script.
 *
