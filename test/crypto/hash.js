...
describe('Hash', function() {
  ...
  /*
  describe('#lyra2re2', function() {
    it('calculates lyra2re2 hash correctly', function() {
      ...
      var hashes = [ "00000000005713ec076ddc189e5d00da593d4b21c9d4e11d851e498186c215e9", "000000000082c02f109e770dd2aa82f48fdd73db95ce225045e39a39ec08563d", "00000000001edcd7236f4957d50b09fbbd573d43dc0b4cfbae5e433d7b72add9", "000000000082b33b0d8fa3e4d3ae8aff190fee838484ac2d90b05bac18240618" ];

      headers.forEach(function(header, i) {
        var data = new Buffer(header, 'hex');
        Hash.lyra2re2(data).toString('hex').should.equal(hashes[i]);
      });
    });
