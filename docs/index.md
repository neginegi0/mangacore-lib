...
* [Peer to Peer Networking](https://github.com/mangacoinproject/mangacore-p2p)
...
var imported = mangacore.PrivateKey.fromWIF(exported);
...
var p2shAddress = new mangacore.Address([publicKey1, publicKey2, publicKey3], 2);
```
...
var uri = new mangacore.URI(paymentInfo).toString();
```
